...
int main() {
    ...
    while (true)
    {
        ...
        cout << "13) Buscar Civilizaciones" << endl;
        cout << "14) Respaldar" << endl;
        cout << "15) Recuperar" << endl;
        cout << "16) Salir" << endl;
        getline(cin, op);
        ...
        if(op == "1"){
            ...
            cout << *ptr << endl;
            Civilizacion a = *ptr;
            Civilizacion civilizacion = v.getCivilizacion(&a);
            menu(civilizacion);*/
            Civilizacion c;
            string civi;
            cout << endl << "Que civilizacion desea Buscar?" << endl;
            ...
            if(v.empty()){
                ...
                for(size_t i = 0; i < v.size(); i++){
                    Civilizacion &civilizacion = v.getCivilizacion(i);
                    cout << i+1 << ")";
                ...
                if(ops > v.size()){
                    ...
                    Civilizacion &civilizacion = v.getCivilizacion(ops-1);
                    menu(civilizacion);
                }
